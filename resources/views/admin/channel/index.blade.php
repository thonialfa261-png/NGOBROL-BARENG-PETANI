...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-bold text-gray-800">Daftar Channel</h2>
    <a href="{{ route('admin.channel.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
        + Tambah Channel
    </a>
</div>
        ...
        <tbody class="divide-y">
            ...
            <tr>
                <td colspan="3" class="px-6 py-10 text-center text-gray-500 italic">
                    Belum ada data Channel. Silakan tambah data baru.
                </td>
            </tr>
            @endforelse
        </tbody>
